"""Generated request builders for the Activities tag."""
...
def get_characters_mercenary_tactical_operations_detail(
    *,
    ...
    request = EsiRequest(
        request_id=uuid4(),
        operation_id="GetCharactersMercenaryTacticalOperationsDetail",
...
def get_characters_mercenary_tactical_operations_listing(
    *,
    auth_character_id: int,
    auth_credential_id: UUID,
    character_id: int,
    ...
    request = EsiRequest(
        request_id=uuid4(),
        operation_id="GetCharactersMercenaryTacticalOperationsListing",
        header_parameters=header_parameters,
        path_parameters=path_parameters,
        query_parameters=query_parameters,
        auth_character_id=auth_character_id,
...
def get_skyhooks_raidable(
    *,
    ...
    request = EsiRequest(
        request_id=uuid4(),
        operation_id="GetSkyhooksRaidable",
        header_parameters=header_parameters,
        path_parameters=path_parameters,
        query_parameters=query_parameters,
    )
