"""Generated request builders for the Structures tag."""
...
def get_characters_structures_mercenary_dens_detail(
    *,
    ...
    path_parameters["mercenary_den_id"] = mercenary_den_id
    ...
    request = EsiRequest(
        request_id=uuid4(),
        operation_id="GetCharactersStructuresMercenaryDensDetail",
...
def get_characters_structures_mercenary_dens_listing(
    *,
    auth_character_id: int,
    auth_credential_id: UUID,
    character_id: int,
    ...
    request = EsiRequest(
        request_id=uuid4(),
        operation_id="GetCharactersStructuresMercenaryDensListing",
        header_parameters=header_parameters,
        path_parameters=path_parameters,
        query_parameters=query_parameters,
        auth_character_id=auth_character_id,
...
def get_corporations_structures_skyhooks_detail(
    *,
    auth_character_id: int,
    auth_credential_id: UUID,
    skyhook_id: int,
    ...
    path_parameters["skyhook_id"] = skyhook_id
    ...
    request = EsiRequest(
        request_id=uuid4(),
        operation_id="GetCorporationsStructuresSkyhooksDetail",
        header_parameters=header_parameters,
        path_parameters=path_parameters,
        query_parameters=query_parameters,
        auth_character_id=auth_character_id,
...
def get_corporations_structures_skyhooks_listing(
    *,
    auth_character_id: int,
    auth_credential_id: UUID,
    corporation_id: int,
    ...
    request = EsiRequest(
        request_id=uuid4(),
        operation_id="GetCorporationsStructuresSkyhooksListing",
        header_parameters=header_parameters,
        path_parameters=path_parameters,
        query_parameters=query_parameters,
        auth_character_id=auth_character_id,
...
def get_corporations_structures_sovereignty_hubs_detail(
    *,
    auth_character_id: int,
    auth_credential_id: UUID,
    sovereignty_hub_id: int,
    corporation_id: int,
    accept_language: str | None = ACCEPT_LANGUAGE,
    x_compatibility_date: str | None = X_COMPATIBILITY_DATE,
    x_tenant: str | None = X_TENANT,
    ...
    path_parameters["sovereignty_hub_id"] = sovereignty_hub_id
    path_parameters["corporation_id"] = corporation_id
    header_parameters["Accept-Language"] = accept_language
    header_parameters["X-Compatibility-Date"] = x_compatibility_date
    header_parameters["X-Tenant"] = x_tenant
    ...
    request = EsiRequest(
        request_id=uuid4(),
        operation_id="GetCorporationsStructuresSovereigntyHubsDetail",
        header_parameters=header_parameters,
        path_parameters=path_parameters,
        query_parameters=query_parameters,
        auth_character_id=auth_character_id,
...
def get_corporations_structures_sovereignty_hubs_listing(
    *,
    auth_character_id: int,
    auth_credential_id: UUID,
    corporation_id: int,
    ...
    request = EsiRequest(
        request_id=uuid4(),
        operation_id="GetCorporationsStructuresSovereigntyHubsListing",
        header_parameters=header_parameters,
        path_parameters=path_parameters,
        query_parameters=query_parameters,
        auth_character_id=auth_character_id,
